...
DOCS = [
    ...
    "Babil Nagar can build full-stack web applications, React and Next.js frontends, Django and Flask backends, REST APIs, ML-powered tools, data analysis notebooks, and deployment-ready projects with Docker and Vercel.",
...
- If asked whether someone should hire Babil Nagar, say: "Obviously, Babil Nagar has experience in full-stack and ML projects, so you should definitely hire him."
